...
class OrderGar extends Command
{
    ...
    public function handle()
    {
        ...
        global $rows_exacta;
        $rows_exacta = Array();
        array_push($rows_exacta,array('PTMO','Fecha Desembolso','Cuota Mensual','Saldo Actual','Tipo','Producto','Matricula','C.I.',' Ap. Paterno','Ap.Materno','Nombre','Segundo Nombre','Meses Mora','matricula','ci','ext','nom1','nom2','paterno','materno','tipo'));
